...
const valueProps = [
  ...
  },
  {
    icon: "verified_user",
    stat: "2 Internships",
    desc: "Production code shipped at SkillCraft Technology & Future Interns.",
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {valueProps.map((v, i) => (
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 80, damping: 16, delay: i * 0.09 }}
        ...
        >
          ...
          <div className="flex items-center gap-3 shrink-0">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-[#FF8A4B] to-[#D84C1B] px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.15em] text-white shadow-[0_6px_20px_rgba(255,124,0,0.28)] hover:-translate-y-0.5 transition-transform"
            >
